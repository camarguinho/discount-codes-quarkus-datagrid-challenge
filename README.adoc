...
I tried on my local machine, but the image 'infinispan/server:12.1.7.Final' is not compatible with Mac M1 (Arm). It runs, but the JVM exits with an Exception error.
